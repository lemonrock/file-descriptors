...
#[cfg(not(any(target_arch = "mips", target_arch = "mips64")))] pub const SI_TIMER: c_int = -2;
#[cfg(any(target_arch = "mips", target_arch = "mips64"))] pub const SI_TIMER: c_int = -3;

/// Caused by libc implementations of POSIX message queues.
///
/// Constant value which is defined differently for the MIPS architecture for no good reason.
#[cfg(not(any(target_arch = "mips", target_arch = "mips64")))] pub const SI_MESGQ: c_int = -3;
#[cfg(any(target_arch = "mips", target_arch = "mips64"))] pub const SI_MESGQ: c_int = -4;

/// Caused by libc implementations of POSIX AIO.
///
/// Constant value which is defined differently for the MIPS architecture for no good reason.
#[cfg(not(any(target_arch = "mips", target_arch = "mips64")))] pub const SI_ASYNCIO: c_int = -4;
#[cfg(any(target_arch = "mips", target_arch = "mips64"))] pub const SI_ASYNCIO: c_int = -2;
