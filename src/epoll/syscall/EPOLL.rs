...
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLIN: uint32_t = 0x001;
...
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLPRI: uint32_t = 0x002;

/// The associated file is available for write operations.
///
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLOUT: uint32_t = 0x004;
...
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLERR: uint32_t = 0x008;
...
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLHUP: uint32_t = 0x010;

/// The specified endpoint descriptor is invalid.
///
/// Valid since Linux 4.16.
pub(crate) const EPOLLNVAL: uint32_t = 0x020;
...
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLRDNORM: uint32_t = 0x040;

/// Out-of-band data available to read.
///
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLRDBAND: uint32_t = 0x080;
...
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLWRNORM: uint32_t = 0x100;

/// Exists for backwards API compatibility with `poll()`.
///
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLWRBAND: uint32_t = 0x200;
...
/// Valid on Solaris.
#[allow(dead_code)]
pub(crate) const EPOLLMSG: uint32_t = 0x400;
...
/// Valid on Solaris.
pub(crate) const EPOLLRDHUP: uint32_t = 0x2000;
...
/// Valid on Solaris.
pub(crate) const EPOLLEXCLUSIVE: uint32_t = 1 << 28;
...
pub(crate) const EPOLLWAKEUP: uint32_t = 1 << 29;
...
pub(crate) const EPOLLONESHOT: uint32_t = 1 << 30;
...
/// Valid on Linux.
/// Valid on Solaris.
pub(crate) const EPOLLET: uint32_t = 1 << 31;
